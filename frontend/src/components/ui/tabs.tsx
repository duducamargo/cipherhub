...
export const Tabs = ({
  ...
  return (
    <>
      <div
        className={cn(
          "flex flex-row items-center overflow-y-auto justify-start [perspective:1000px] relative overflow-auto sm:overflow-visible no-visible-scrollbar max-w-full w-full whitespace-nowrap",
          containerClassName
        )}
      >
