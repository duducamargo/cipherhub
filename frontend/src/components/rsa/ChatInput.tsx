...
import { SendHorizonal, Lock, Unlock } from "lucide-react";
...
export const ChatInput: React.FC<ChatInputProps> = ({
  ...
  return (
    <div className="p-4 border-t border-neutral-800 bg-neutral-800 flex items-center gap-3">
      ...
      />
      <button
        className="flex-shrink-0 p-3 bg-pink-500 text-white rounded-lg hover:bg-pink-600 transition-all transform hover:scale-[1.05] active:scale-95 shadow-md shadow-pink-900/50"
