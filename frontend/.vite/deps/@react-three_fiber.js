  ...
  "node_modules/react-reconciler/cjs/react-reconciler-constants.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        exports.NoEventPriority = NoEventPriority2;
      })();
    }
  }
});
  ...
  "node_modules/react-reconciler/node_modules/scheduler/cjs/scheduler.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        function flushWork(initialTime2) {
        ...
        function workLoop(initialTime2) {
  ...
  "node_modules/react-reconciler/cjs/react-reconciler.development.js"(exports, module) {
    ...
    if (true) {
      module.exports = function $$$reconciler($$$config) {
          ...
          if (typeof type === "object") {
            ...
            switch (type.$$typeof) {
              ...
              case REACT_CONTEXT_TYPE:
                var context2 = type;
                {
                  return getContextName$1(context2) + ".Provider";
                }
        ...
        var MutationMask = Placement | Update2 | ChildDeletion | ContentReset | Ref | Hydrating | Visibility | FormReset;
        ...
        var createInstance2 = $$$config.createInstance;
        ...
        var appendChild2 = $$$config.appendChild;
        ...
        function getEntangledLanes(root, renderLanes2) {
          var entangledLanes = renderLanes2;
        ...
        function markRootFinished(root, remainingLanes, spawnedLane) {
          ...
          while (lanes > 0) {
            ...
            if (hiddenUpdatesForLane !== null) {
              ...
              for (var i2 = 0; i2 < hiddenUpdatesForLane.length; i2++) {
                var update2 = hiddenUpdatesForLane[i2];
                if (update2 !== null) {
                  update2.lane &= ~OffscreenLane;
                }
              }
            }
            lanes &= ~lane;
        ...
        function markHiddenUpdate(root, update2, lane) {
          var index2 = laneToIndex(lane);
          var hiddenUpdates = root.hiddenUpdates;
          var hiddenUpdatesForLane = hiddenUpdates[index2];
          if (hiddenUpdatesForLane === null) {
            hiddenUpdates[index2] = [update2];
          } else {
            hiddenUpdatesForLane.push(update2);
          }
          update2.lane = lane | OffscreenLane;
        }
        ...
        function injectInternals(internals) {
          ...
          if (!hook.supportsFiber) {
            {
              error2("The installed version of React DevTools is too old and will not work with the current version of React. Please update React DevTools. https://react.dev/link/react-devtools");
            }
            return true;
          }
          try {
        ...
        function requiredContext(c) {
          {
            if (c === null) {
              error2("Expected host context to exist. This error is likely caused by a bug in React. Please file an issue.");
            }
          }
          return c;
        }
        ...
        function findNotableNode(node, indent) {
          if (node.serverProps === void 0 && node.serverTail.length === 0 && node.children.length === 1 && node.distanceFromLeaf > 3 && node.distanceFromLeaf > idealDepth - indent) {
        ...
        function describeFiberType(fiber) {
          switch (fiber.tag) {
            ...
            case ForwardRef:
              var render2 = fiber.type.render;
              return render2.displayName || render2.name || null;
            case ClassComponent:
              var ctr = fiber.type;
        ...
        function describeElementDiff(type, clientProps, serverProps, indent) {
          ...
          if (serverPropNames.size === 1 && serverPropNames.has("children")) {
            ...
            serverPropNames.forEach(function(propName2) {
              if (propName2 === "children") {
                return;
              }
              var maxLength2 = maxRowLength - (indent + 1) * 2 - propName2.length - 1;
              content += removed(indent + 1) + propName2 + "=" + describePropValue(serverProps[propName2], maxLength2) + "\n";
            });
            if (content === "") {
          ...
          if (typeof serverChildren === "string" || typeof serverChildren === "number" || typeof serverChildren === "bigint") {
            ...
            content += describeTextDiff("" + clientChildren, void 0, indent + 1);
          }
          return content;
        }
          ...
          if (node.fiber.tag === HostText) {
            ...
            if (type !== null) {
              if (node.serverProps === void 0) {
                ...
                {
                  error2("Should not have matched a non HostText fiber to a Text node. This is a bug in React.");
                }
              } else {
        ...
        function throwOnHydrationMismatch(fiber) {
          ...
          var error3 = new Error("Hydration failed because the server rendered HTML didn't match the client. As a result this tree will be regenerated on the client. This can happen if a SSR-ed Client Component used:\n\n- A server/client branch `if (typeof window !== 'undefined')`.\n- Variable input such as `Date.now()` or `Math.random()` which changes each time it's called.\n- Date formatting in a user's locale which doesn't match the server.\n- External changing data without sending a snapshot of it along with the HTML.\n- Invalid HTML tag nesting.\n\nIt can also happen if the client has a browser extension installed which messes with the HTML before React loaded.\n\nhttps://react.dev/link/hydration-mismatch" + diff);
        ...
        function emitPendingHydrationWarnings() {
          {
            ...
            if (diffRoot !== null) {
              ...
              error2("A tree hydrated but some attributes of the server rendered HTML didn't match the client properties. This won't be patched up. This can happen if a SSR-ed Client Component used:\n\n- A server/client branch `if (typeof window !== 'undefined')`.\n- Variable input such as `Date.now()` or `Math.random()` which changes each time it's called.\n- Date formatting in a user's locale which doesn't match the server.\n- External changing data without sending a snapshot of it along with the HTML.\n- Invalid HTML tag nesting.\n\nIt can also happen if the client has a browser extension installed which messes with the HTML before React loaded.\n\n%s%s", "https://react.dev/link/hydration-mismatch", diff);
            }
          }
        }
        ...
        function finishQueueingConcurrentUpdates() {
          ...
          while (i2 < endIndex) {
            ...
            if (lane !== NoLane) {
              markUpdateLaneFromFiberToRoot(fiber, update2, lane);
            }
          }
        }
        ...
        function enqueueConcurrentHookUpdate(fiber, queue, update2, lane) {
          ...
          var concurrentUpdate = update2;
          enqueueUpdate$1(fiber, concurrentQueue, concurrentUpdate, lane);
          return getRootForUpdatedFiber(fiber);
        }
        function enqueueConcurrentHookUpdateAndEagerlyBailout(fiber, queue, update2) {
          var lane = NoLane;
          var concurrentQueue = queue;
          var concurrentUpdate = update2;
          enqueueUpdate$1(fiber, concurrentQueue, concurrentUpdate, lane);
        ...
        function markUpdateLaneFromFiberToRoot(sourceFiber, update2, lane) {
          ...
          if (isHidden && update2 !== null && node.tag === HostRoot) {
            var root = node.stateNode;
            markHiddenUpdate(root, update2, lane);
          }
        }
          ...
          do {
            ...
            while (root !== null) {
              if (onlyLegacy && disableLegacyMode) ;
                ...
                var nextLanes = getNextLanes(root, root === workInProgressRoot2 ? workInProgressRootRenderLanes2 : NoLanes);
        ...
        function scheduleTaskForRootDuringMicrotask(root, currentTime) {
          ...
          if (
            ...
            root === workInProgressRoot2 && isWorkLoopSuspendedOnData() || // Suspended commit phase
        ...
        function processUpdateQueue(workInProgress2, props, instance, renderLanes2) {
          ...
          if (firstBaseUpdate !== null) {
            ...
            var update2 = firstBaseUpdate;
            do {
              var updateLane = removeLanes(update2.lane, OffscreenLane);
              var isHiddenUpdate = updateLane !== update2.lane;
        ...
        function commitHiddenCallbacks(updateQueue, context2) {
          ...
          if (hiddenCallbacks !== null) {
            ...
            for (var i2 = 0; i2 < hiddenCallbacks.length; i2++) {
              var callback = hiddenCallbacks[i2];
              callCallback(callback, context2);
            }
          }
        }
        ...
        };
        {
          ...
          ReactStrictModeWarnings.flushPendingUnsafeLifecycleWarnings = function() {
            ...
            if (UNSAFE_componentWillMountUniqueNames.size > 0) {
              ...
              error2("Using UNSAFE_componentWillMount in strict mode is not recommended and may indicate bugs in your code. See https://react.dev/link/unsafe-component-lifecycles for details.\n\n* Move code with side effects to componentDidMount, and set initial state in the constructor.\n\nPlease update the following components: %s", sortedNames);
            }
            if (UNSAFE_componentWillReceivePropsUniqueNames.size > 0) {
              var _sortedNames = setToSortedString(UNSAFE_componentWillReceivePropsUniqueNames);
              error2("Using UNSAFE_componentWillReceiveProps in strict mode is not recommended and may indicate bugs in your code. See https://react.dev/link/unsafe-component-lifecycles for details.\n\n* Move data fetching code or side effects to componentDidUpdate.\n* If you're updating state whenever props change, refactor your code to use memoization techniques or move it to static getDerivedStateFromProps. Learn more at: https://react.dev/link/derived-state\n\nPlease update the following components: %s", _sortedNames);
            }
            if (UNSAFE_componentWillUpdateUniqueNames.size > 0) {
              var _sortedNames2 = setToSortedString(UNSAFE_componentWillUpdateUniqueNames);
              error2("Using UNSAFE_componentWillUpdate in strict mode is not recommended and may indicate bugs in your code. See https://react.dev/link/unsafe-component-lifecycles for details.\n\n* Move data fetching code or side effects to componentDidUpdate.\n\nPlease update the following components: %s", _sortedNames2);
            }
        ...
        function getThenablesFromState(state2) {
          {
            var devState = state2;
        ...
        var noopSuspenseyCommitThenable = {
          then: function() {
            {
              error2('Internal React error: A listener was unexpectedly attached to a "noop" thenable. This is a bug in React. Please file an issue.');
            }
          }
        };
        ...
        function trackUsedThenable(thenableState2, thenable, index2) {
          ...
          var trackedThenables = getThenablesFromState(thenableState2);
          var previous = trackedThenables[index2];
          if (previous === void 0) {
            trackedThenables.push(thenable);
          } else {
            if (previous !== thenable) {
              {
                var thenableStateDev = thenableState2;
                if (!thenableStateDev.didWarnAboutUncachedPromise) {
                  thenableStateDev.didWarnAboutUncachedPromise = true;
                  error2("A component was suspended by an uncached promise. Creating promises inside a Client Component or hook is not yet supported, except via a Suspense-compatible library or framework.");
                }
              }
              ...
              if (typeof thenable.status === "string") {
                ...
                pendingThenable.then(function(fulfilledValue2) {
                  ...
                  if (thenable.status === "pending") {
                    ...
                    rejectedThenable2.reason = error3;
                  }
                });
              }
              switch (thenable.status) {
        ...
        };
        {
          ...
          warnForMissingKey = function(child, returnFiber) {
            ...
            var componentKey = componentName2 || "null";
            ...
            setCurrentFiber(fiber);
            error2('Each child in a list should have a unique "key" prop.%s%s See https://react.dev/link/warning-keys for more information.', currentComponentErrorInfo, childOwnerAppendix);
        ...
        function warnOnFunctionType(returnFiber, invalidChild) {
          {
            ...
            if (returnFiber.tag === HostRoot) {
              error2("Functions are not valid as a React child. This may happen if you return %s instead of <%s /> from render. Or maybe you meant to call this function rather than return it.\n  root.render(%s)", name, name, name);
            } else {
        ...
        function warnOnSymbolType(returnFiber, invalidChild) {
          {
            ...
            if (returnFiber.tag === HostRoot) {
              error2("Symbols are not valid as a React child.\n  root.render(%s)", name);
            } else {
        ...
        function createChildReconciler(shouldTrackSideEffects) {
          ...
          function updateTextNode(returnFiber, current2, textContent, lanes, debugInfo) {
          ...
          function updateElement(returnFiber, current2, element, lanes, debugInfo) {
            var elementType = element.type;
            if (elementType === REACT_FRAGMENT_TYPE) {
              var updated = updateFragment2(returnFiber, current2, element.props.children, lanes, element.key, debugInfo);
            ...
            if (current2 !== null) {
              ...
              typeof elementType === "object" && elementType !== null && elementType.$$typeof === REACT_LAZY_TYPE && resolveLazy(elementType) === current2.type) {
                ...
                coerceRef(returnFiber, current2, existing, element);
                existing.return = returnFiber;
                {
            ...
            coerceRef(returnFiber, current2, created, element);
            created.return = returnFiber;
            {
              created._debugInfo = debugInfo;
            }
          ...
          function updatePortal(returnFiber, current2, portal, lanes, debugInfo) {
          ...
          function updateFragment2(returnFiber, current2, fragment, lanes, key, debugInfo) {
          ...
          function createChild(returnFiber, newChild, lanes, debugInfo) {
            ...
            if (typeof newChild === "object" && newChild !== null) {
              ...
              if (newChild.$$typeof === REACT_CONTEXT_TYPE) {
                var context2 = newChild;
                return createChild(returnFiber, readContextDuringReconciliation(returnFiber, context2, lanes), lanes, debugInfo);
              }
          ...
          function updateSlot(returnFiber, oldFiber, newChild, lanes, debugInfo) {
            ...
            if (typeof newChild === "object" && newChild !== null) {
              ...
              if (isArray(newChild) || getIteratorFn(newChild) || enableAsyncIterableChildren) {
                ...
                return updateFragment2(returnFiber, oldFiber, newChild, lanes, null, mergeDebugInfo(debugInfo, newChild._debugInfo));
              }
              if (typeof newChild.then === "function") {
                var thenable = newChild;
              ...
              if (newChild.$$typeof === REACT_CONTEXT_TYPE) {
                var context2 = newChild;
                return updateSlot(returnFiber, oldFiber, readContextDuringReconciliation(returnFiber, context2, lanes), lanes, debugInfo);
              }
              throwOnInvalidObjectType(returnFiber, newChild);
            }
            {
          ...
          function updateFromMap(existingChildren, returnFiber, newIdx, newChild, lanes, debugInfo) {
            ...
            if (typeof newChild === "object" && newChild !== null) {
              ...
              if (isArray(newChild) || getIteratorFn(newChild) || enableAsyncIterableChildren) {
                ...
                return updateFragment2(returnFiber, _matchedFiber3, newChild, lanes, null, mergeDebugInfo(debugInfo, newChild._debugInfo));
              }
              if (typeof newChild.then === "function") {
                var thenable = newChild;
              ...
              if (newChild.$$typeof === REACT_CONTEXT_TYPE) {
                var context2 = newChild;
                return updateFromMap(existingChildren, returnFiber, newIdx, readContextDuringReconciliation(returnFiber, context2, lanes), lanes, debugInfo);
              }
              throwOnInvalidObjectType(returnFiber, newChild);
            }
            {
          ...
          function reconcileChildFibersImpl(returnFiber, currentFirstChild, newChild, lanes, debugInfo) {
            ...
            if (typeof newChild === "object" && newChild !== null) {
              ...
              if (newChild.$$typeof === REACT_CONTEXT_TYPE) {
                var context2 = newChild;
                return reconcileChildFibersImpl(returnFiber, currentFirstChild, readContextDuringReconciliation(returnFiber, context2, lanes), lanes, debugInfo);
              }
              throwOnInvalidObjectType(returnFiber, newChild);
            }
            if (typeof newChild === "string" && newChild !== "" || typeof newChild === "number" || typeof newChild === "bigint") {
        ...
        function pushHiddenContext(fiber, context2) {
          ...
          setEntangledRenderLanes(mergeLanes(prevEntangledRenderLanes, context2.baseLanes));
        }
        ...
        function warnOnHookMismatchInDev(currentHookName) {
          {
            ...
            if (!didWarnAboutMismatchedHooksForComponent.has(componentName2)) {
              ...
              if (hookTypesDev !== null) {
                ...
                error2("React has detected a change in the order of Hooks called by %s. This will lead to bugs and errors if not fixed. For more information, read the Rules of Hooks: https://react.dev/link/rules-of-hooks\n\n   Previous render            Next render\n   ------------------------------------------------------\n%s   ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\n", componentName2, table);
              }
            }
          }
        }
        function warnOnUseFormStateInDev() {
          {
            var componentName2 = getComponentNameFromFiber(currentlyRenderingFiber$1);
            if (!didWarnAboutUseFormState.has(componentName2)) {
              didWarnAboutUseFormState.add(componentName2);
              error2("ReactDOM.useFormState has been renamed to React.useActionState. Please update %s to use React.useActionState.", componentName2);
            }
          }
        }
        function warnIfAsyncClientComponent(Component3) {
          {
            var isAsyncFunction = (
              // $FlowIgnore[method-unbinding]
              Object.prototype.toString.call(Component3) === "[object AsyncFunction]" || // $FlowIgnore[method-unbinding]
              Object.prototype.toString.call(Component3) === "[object AsyncGeneratorFunction]"
            );
            if (isAsyncFunction) {
              var componentName2 = getComponentNameFromFiber(currentlyRenderingFiber$1);
              if (!didWarnAboutAsyncClientComponent.has(componentName2)) {
                didWarnAboutAsyncClientComponent.add(componentName2);
                error2("async/await is not yet supported in Client Components, only Server Components. This error is often caused by accidentally adding `'use client'` to a module that was originally written for the server.");
              }
            }
          }
        }
        ...
        function renderWithHooks(current2, workInProgress2, Component3, props, secondArg, nextRenderLanes) {
          ...
          currentlyRenderingFiber$1 = workInProgress2;
          {
            ...
            warnIfAsyncClientComponent(Component3);
          }
          ...
          if (didScheduleRenderPhaseUpdateDuringThisPass) {
            children = renderWithHooksAgain(workInProgress2, Component3, props, secondArg);
          }
        ...
        function finishRenderingHooks(current2, workInProgress2, Component3) {
          {
          ...
          }
          {
            if (checkIfUseWrappedInTryCatch()) {
              var componentName2 = getComponentNameFromFiber(workInProgress2) || "Unknown";
              if (!didWarnAboutUseWrappedInTryCatch.has(componentName2) && // This warning also fires if you suspend with `use` inside an
              // async component. Since we warn for that above, we'll silence this
              // second warning by checking here.
              !didWarnAboutAsyncClientComponent.has(componentName2)) {
                didWarnAboutUseWrappedInTryCatch.add(componentName2);
                error2("`use` was called from inside a try/catch block. This is not allowed and can lead to unexpected behavior. To handle errors triggered by `use`, wrap your component in a error boundary.");
              }
            }
          }
        }
        function replaySuspendedComponentWithHooks(current2, workInProgress2, Component3, props, secondArg) {
          {
            hookTypesUpdateIndexDev = -1;
            ignorePreviousDependencies = current2 !== null && current2.type !== workInProgress2.type;
          }
          var children = renderWithHooksAgain(workInProgress2, Component3, props, secondArg);
          finishRenderingHooks(current2, workInProgress2);
          return children;
        }
        ...
        function bailoutHooks(current2, workInProgress2, lanes) {
          ...
          if ((workInProgress2.mode & StrictEffectsMode) !== NoMode) {
            workInProgress2.flags &= ~(MountPassiveDev | MountLayoutDev | Passive$1 | Update2);
          } else {
            workInProgress2.flags &= ~(Passive$1 | Update2);
          }
        ...
        function useMemoCache(size) {
          ...
          if (data === void 0) {
            ...
            {
              error2("Expected a constant size argument for each invocation of useMemoCache. The previous cache was allocated with size %s but size %s was requested.", data.length, size);
            }
          }
          memoCache.index++;
          return data;
        ...
        function updateReducerImpl(hook, current2, reducer) {
          ...
          if (baseQueue === null) {
            ...
            var update2 = first;
            var didReadFromEntangledAsyncAction2 = false;
            do {
              var updateLane = removeLanes(update2.lane, OffscreenLane);
              var isHiddenUpdate = updateLane !== update2.lane;
        ...
        function updateSyncExternalStore(subscribe, getSnapshot, getServerSnapshot) {
          ...
          workInProgressHook !== null && workInProgressHook.memoizedState.tag & HasEffect) {
            ...
            if (!isHydrating2 && !includesBlockingLane(root, renderLanes)) {
              pushStoreConsistencyCheck(fiber, getSnapshot, nextSnapshot);
            }
          }
          return nextSnapshot;
        ...
        function updateActionStateImpl(stateHook, currentStateHook, action, initialState, permalink) {
          ...
          var state2 = typeof actionResult === "object" && actionResult !== null && // $FlowFixMe[method-unbinding]
          ...
          return [state2, dispatch, isPending];
        }
        ...
        function rerenderActionState(action, initialState, permalink) {
          ...
          var state2 = stateHook.memoizedState;
          var actionQueueHook = updateWorkInProgressHook();
          var actionQueue = actionQueueHook.queue;
          var dispatch = actionQueue.dispatch;
          actionQueueHook.memoizedState = action;
          return [state2, dispatch, false];
        }
        ...
        function mountInsertionEffect(create, deps) {
          mountEffectImpl(Update2, Insertion, create, deps);
        }
        function updateInsertionEffect(create, deps) {
          return updateEffectImpl(Update2, Insertion, create, deps);
        }
        function mountLayoutEffect(create, deps) {
          var fiberFlags = Update2 | LayoutStatic;
        ...
        function updateImperativeHandle(ref, create, deps) {
          ...
          var effectDeps = deps !== null && deps !== void 0 ? deps.concat([ref]) : null;
          updateEffectImpl(Update2, Layout, imperativeHandleEffect.bind(null, create, ref), effectDeps);
        }
        ...
        function requestFormReset(formFiber) {
          ...
          {
            if (transition === null) {
              error2("requestFormReset was called outside a transition or action. To fix, move to an action, or wrap with startTransition.");
            }
          }
          var stateHook = ensureFormComponentIsStateful(formFiber);
          var newResetState = {};
          ...
          while (provider !== null) {
            switch (provider.tag) {
              ...
              case HostRoot: {
                ...
                if (seedKey !== null && seedKey !== void 0 && root !== null) {
                  {
                    {
                      error2("The seed argument is not enabled outside experimental channels.");
                    }
                  }
                }
                var payload = {
              ...
              if (lastRenderedReducer !== null) {
                ...
                try {
                  ...
                  if (objectIs(eagerState, currentState)) {
                    enqueueConcurrentHookUpdateAndEagerlyBailout(fiber, queue, update2);
                    return;
                  }
                } catch (error3) {
                } finally {
        ...
        function dispatchOptimisticSetState(fiber, throwIfDuringRender, queue, action) {
          var transition = requestCurrentTransition();
          {
            if (transition === null) {
              if (peekEntangledActionLane() !== NoLane) ;
                ...
                error2("An optimistic state update occurred outside a transition or action. To fix, move the update to an action, or wrap with startTransition.");
              }
            }
          }
          var update2 = {
          ...
          if (isRenderPhaseUpdate(fiber)) {
            if (throwIfDuringRender) {
              ...
              {
                error2("Cannot call startTransition while rendering.");
              }
            }
          } else {
            var root = enqueueConcurrentHookUpdate(fiber, queue, update2, SyncLane);
            if (root !== null) {
              scheduleUpdateOnFiber(root, fiber, SyncLane);
            }
          }
        ...
        var InvalidNestedHooksDispatcherOnRerenderInDEV = null;
        {
          ...
          var warnInvalidHookAccess = function() {
            error2("Do not call Hooks inside useEffect(...), useMemo(...), or other built-in Hooks. You can only call Hooks at the top level of your React function. For more information, see https://react.dev/link/rules-of-hooks");
          };
        ...
        function warnOnInvalidCallback(callback) {
          {
            ...
            if (!didWarnOnInvalidCallback.has(key)) {
              ...
              error2("Expected the last optional `callback` argument to be a function. Instead received: %s.", callback);
            }
          }
        }
          ...
          var instance = workInProgress2.stateNode;
          {
            ...
            if (!renderPresent) {
              if (ctor.prototype && typeof ctor.prototype.render === "function") {
                error2("No `render` method found on the %s instance: did you accidentally return an object from the constructor?", name);
              } else {
                error2("No `render` method found on the %s instance: you may have forgotten to define `render`.", name);
              }
            }
            ...
            }
            {
              if (ctor.childContextTypes) {
                error2("%s uses the legacy childContextTypes API which was removed in React 19. Use React.createContext() instead.", name);
              }
              if (ctor.contextTypes) {
                error2("%s uses the legacy contextTypes API which was removed in React 19. Use React.createContext() with static contextType instead.", name);
              }
            }
            ...
            if (instance.props !== void 0 && hasMutatedProps) {
              error2("When calling super() in `%s`, make sure to pass up the same props that your component's constructor was passed.", name);
            }
            ...
            if (state2 && (typeof state2 !== "object" || isArray(state2))) {
        ...
        function mountClassInstance(workInProgress2, ctor, newProps, renderLanes2) {
          ...
          if (typeof instance.componentDidMount === "function") {
            workInProgress2.flags |= Update2 | LayoutStatic;
          }
          if ((workInProgress2.mode & StrictEffectsMode) !== NoMode) {
        ...
        function resumeMountClassInstance(workInProgress2, ctor, newProps, renderLanes2) {
          ...
          var didReceiveNewProps = unresolvedNewProps !== unresolvedOldProps;
        ...
        function resolveClassComponentProps(Component3, baseProps, alreadyResolvedDefaultProps) {
        ...
        var reportGlobalError = typeof reportError === "function" ? (
          ...
          if (typeof window === "object" && typeof window.ErrorEvent === "function") {
            var message = typeof error3 === "object" && error3 !== null && typeof error3.message === "string" ? (
        ...
        function defaultOnUncaughtError(error3, errorInfo) {
        ...
        function defaultOnRecoverableError(error3, errorInfo) {
          reportGlobalError(error3);
        }
        ...
        function throwException(root, returnFiber, sourceFiber, value, rootRenderLanes) {
          ...
          if (getIsHydrating() && disableLegacyMode) {
            ...
            if (_suspenseBoundary !== null) {
              ...
              var _workInProgress = root.current.alternate;
          ...
          do {
            switch (workInProgress2.tag) {
              case HostRoot: {
                ...
                var _update = createRootErrorUpdate(workInProgress2.stateNode, errorInfo, _lane);
              ...
              case ClassComponent:
                ...
                if ((workInProgress2.flags & DidCapture) === NoFlags$1 && (typeof ctor.getDerivedStateFromError === "function" || instance !== null && typeof instance.componentDidCatch === "function" && !isAlreadyFailedLegacyErrorBoundary(instance))) {
                  ...
                  workInProgress2.lanes = mergeLanes(workInProgress2.lanes, _lane2);
                  var _update2 = createClassErrorUpdate(_lane2);
                  initializeClassErrorUpdate(_update2, root, workInProgress2, errorInfo);
        ...
        function updateForwardRef(current2, workInProgress2, Component3, nextProps, renderLanes2) {
          ...
          {
            setIsRendering(true);
            nextChildren = renderWithHooks(current2, workInProgress2, render2, propsWithoutRef, ref, renderLanes2);
        ...
        function updateOffscreenComponent(current2, workInProgress2, renderLanes2) {
          ...
          if (nextProps.mode === "hidden" || enableLegacyHidden || nextIsDetached) {
            ...
            if (!includesSomeLane(renderLanes2, OffscreenLane)) {
        ...
        function updateFunctionComponent(current2, workInProgress2, Component3, nextProps, renderLanes2) {
          {
            ...
            if (current2 === null) {
              ...
              if (Component3.contextTypes) {
                error2("%s uses the legacy contextTypes API which was removed in React 19. Use React.createContext() with React.useContext() instead.", getComponentNameFromType(Component3) || "Unknown");
              }
            }
          }
          var context2;
        ...
        function replayFunctionComponent(current2, workInProgress2, nextProps, Component3, secondArg, renderLanes2) {
          ...
          var nextChildren = replaySuspendedComponentWithHooks(current2, workInProgress2, Component3, nextProps, secondArg);
        ...
        function updateClassComponent(current2, workInProgress2, Component3, nextProps, renderLanes2) {
          {
            switch (shouldError(workInProgress2)) {
              ...
              case true: {
                ...
                var update2 = createClassErrorUpdate(lane);
                initializeClassErrorUpdate(update2, root, workInProgress2, createCapturedValueAtFiber(error$1, workInProgress2));
        ...
        function updateHostRoot(current2, workInProgress2, renderLanes2) {
          ...
          if (supportsHydration && prevState.isDehydrated) {
            ...
            if (workInProgress2.flags & ForceClientRender) {
              return mountHostRootWithoutHydrating(current2, workInProgress2, nextChildren, renderLanes2);
            } else if (nextChildren !== prevChildren) {
              var recoverableError = createCapturedValueAtFiber(new Error("This root received an early update, before anything was able hydrate. Switched the entire root to client rendering."), workInProgress2);
        ...
        function mountLazyComponent(_current, workInProgress2, elementType, renderLanes2) {
          ...
          if (typeof Component3 === "function") {
            if (isFunctionClassComponent(Component3)) {
              var resolvedProps = resolveClassComponentProps(Component3, props);
              workInProgress2.tag = ClassComponent;
              {
                workInProgress2.type = Component3 = resolveClassForHotReloading(Component3);
              }
              return updateClassComponent(null, workInProgress2, Component3, resolvedProps, renderLanes2);
            } else {
              ...
              return updateFunctionComponent(null, workInProgress2, Component3, _resolvedProps, renderLanes2);
            }
            ...
            if ($$typeof === REACT_FORWARD_REF_TYPE) {
              ...
              return updateForwardRef(null, workInProgress2, Component3, _resolvedProps2, renderLanes2);
        ...
        function validateFunctionComponentInDev(workInProgress2, Component3) {
          {
            if (Component3) {
              if (Component3.childContextTypes) {
                error2("childContextTypes cannot be defined on a function component.\n  %s.childContextTypes = ...", Component3.displayName || Component3.name || "Component");
              }
            }
            if (typeof Component3.getDerivedStateFromProps === "function") {
              ...
              if (!didWarnAboutGetDerivedStateOnFunctionComponent[_componentName2]) {
                error2("%s: Function components do not support getDerivedStateFromProps.", _componentName2);
            ...
            if (typeof Component3.contextType === "object" && Component3.contextType !== null) {
              ...
              if (!didWarnAboutContextTypeOnFunctionComponent[_componentName3]) {
                error2("%s: Function components do not support contextType.", _componentName3);
        ...
        function getRemainingWorkInPrimaryTree(current2, primaryTreeDidDefer, renderLanes2) {
          var remainingLanes = current2 !== null ? removeLanes(current2.childLanes, renderLanes2) : NoLanes;
        ...
        function updateSuspenseComponent(current2, workInProgress2, renderLanes2) {
          ...
          var didPrimaryChildrenDefer = (workInProgress2.flags & DidDefer) !== NoFlags$1;
          ...
          if (current2 === null) {
            ...
            if (showFallback) {
              ...
              primaryChildFragment.childLanes = getRemainingWorkInPrimaryTree(current2, didPrimaryChildrenDefer, renderLanes2);
            ...
            if (prevState !== null) {
              ...
              if (_dehydrated !== null) {
                return updateDehydratedSuspenseComponent(current2, workInProgress2, didSuspend, didPrimaryChildrenDefer, nextProps, _dehydrated, prevState, renderLanes2);
              }
            }
            if (showFallback) {
              pushFallbackTreeSuspenseHandler(workInProgress2);
              ...
              _primaryChildFragment2.childLanes = getRemainingWorkInPrimaryTree(current2, didPrimaryChildrenDefer, renderLanes2);
              workInProgress2.memoizedState = SUSPENDED_MARKER;
              return fallbackChildFragment;
            } else {
              pushPrimaryTreeSuspenseHandler(workInProgress2);
              var _nextPrimaryChildren2 = nextProps.children;
              var _primaryChildFragment3 = updateSuspensePrimaryChildren(current2, workInProgress2, _nextPrimaryChildren2);
              workInProgress2.memoizedState = null;
          ...
          if (!didSuspend) {
            ...
            if (isSuspenseInstanceFallback(suspenseInstance)) {
              ...
              }
              {
                ...
                error3.stack = stack || "";
                error3.digest = digest;
                var capturedValue = createCapturedValueFromError(error3, componentStack === void 0 ? null : componentStack);
            ...
            if (didReceiveUpdate || hasContextChanged2) {
              ...
              if (root !== null) {
                ...
                if (attemptHydrationAtLane !== NoLane && attemptHydrationAtLane !== suspenseState.retryLane) {
                  ...
                  scheduleUpdateOnFiber(root, current2, attemptHydrationAtLane);
            ...
            if (workInProgress2.flags & ForceClientRender) {
              ...
              _primaryChildFragment4.childLanes = getRemainingWorkInPrimaryTree(current2, didPrimaryChildrenDefer, renderLanes2);
              workInProgress2.memoizedState = SUSPENDED_MARKER;
              return fallbackChildFragment;
            }
          }
        ...
        function updateContextConsumer(current2, workInProgress2, renderLanes2) {
          var context2;
          {
            var consumerType = workInProgress2.type;
            context2 = consumerType._context;
          }
          var newProps = workInProgress2.pendingProps;
        ...
        function beginWork(current2, workInProgress2, renderLanes2) {
          ...
          switch (workInProgress2.tag) {
            ...
            case ClassComponent: {
              ...
              return updateClassComponent(current2, workInProgress2, _Component, _resolvedProps4, renderLanes2);
            }
            case HostRoot:
            ...
            case ForwardRef: {
              ...
              return updateForwardRef(current2, workInProgress2, type, _resolvedProps5, renderLanes2);
            }
            case Fragment3:
            ...
            case MemoComponent: {
              ...
              return updateMemoComponent(current2, workInProgress2, _type, _resolvedProps6, renderLanes2);
            }
            case SimpleMemoComponent: {
        ...
        function pushProvider(providerFiber, context2, nextValue) {
          if (isPrimaryRenderer) {
            ...
            {
              push(renderer2CursorDEV, context2._currentRenderer2, providerFiber);
        ...
        function popProvider(context2, providerFiber) {
          ...
          if (isPrimaryRenderer) {
            ...
            context2._currentValue2 = currentValue;
            {
              ...
              context2._currentRenderer2 = currentRenderer2;
            }
          }
        ...
        function readContextDuringReconciliation(consumer, context2, renderLanes2) {
        ...
        function requestCacheFromPool(renderLanes2) {
          ...
          if (freshCache !== null) {
            root.pooledCacheLanes |= renderLanes2;
          }
          return freshCache;
        }
        ...
        function appendAllChildren(parent, workInProgress2, needsVisibilityToggle, isHidden) {
          if (supportsMutation) {
            ...
            var _node = workInProgress2.child;
            while (_node !== null) {
        ...
        function updateHostComponent(current2, workInProgress2, type, newProps, renderLanes2) {
          if (supportsMutation) {
            ...
            var _oldProps = current2.memoizedProps;
            var requiresClone = doesRequireClone(current2, workInProgress2);
              ...
              if (supportsResources) {
                ...
                if (current2 === null) {
                  ...
                  if (nextResource !== null) {
                    ...
                    bubbleProperties(workInProgress2);
                    preloadInstanceAndSuspendIfNeeded(workInProgress2, type, newProps);
                    return null;
                  }
                } else {
            ...
            case HostComponent: {
              ...
              if (current2 !== null && workInProgress2.stateNode != null) {
                ...
                if (_wasHydrated2) {
                  ...
                  var _instance3 = createInstance2(_type2, newProps, _rootContainerInstance, _currentHostContext, workInProgress2);
                  appendAllChildren(_instance3, workInProgress2, false, false);
            ...
            case HostText: {
              ...
              if (current2 && workInProgress2.stateNode != null) {
                ...
                if (_wasHydrated3) {
                  ...
                  workInProgress2.stateNode = createTextInstance(newText, _rootContainerInstance2, _currentHostContext2, workInProgress2);
                }
              }
              bubbleProperties(workInProgress2);
              return null;
        ...
        function commitPassiveEffectDurations(finishedRoot, finishedWork) {
          if (getExecutionContext() & CommitContext) {
            if ((finishedWork.flags & Update2) !== NoFlags$1) {
              switch (finishedWork.tag) {
                case Profiler: {
        ...
        function commitLayoutEffectOnFiber(finishedRoot, current2, finishedWork, committedLanes) {
          ...
          switch (finishedWork.tag) {
            ...
            case HostComponent: {
              recursivelyTraverseLayoutEffects(finishedRoot, finishedWork);
              if (current2 === null && flags & Update2) {
            ...
            if (typeof ref === "function") {
            ...
            } else {
              {
                if (typeof ref === "string") {
                  error2("String refs are no longer supported.");
                ...
                if (updateQueue !== null) {
                  ...
                  if (lastEffect !== null) {
                    ...
                    do {
                      ...
                      var destroy = inst.destroy;
                      if (destroy !== void 0) {
                        if ((tag & Insertion) !== NoFlags2) {
                          inst.destroy = void 0;
                          safelyCallDestroy(deletedFiber, nearestMountedAncestor, destroy);
                        } else if ((tag & Layout) !== NoFlags2) {
                          {
              ...
              if (supportsResources) {
                ...
                if (flags & Update2) {
                  ...
                  if (current2 === null) {
                    ...
                    try {
                      commitUpdate(finishedWork.stateNode, finishedWork.type, current2.memoizedProps, finishedWork.memoizedProps, finishedWork);
                    } catch (error3) {
                      captureCommitPhaseError(finishedWork, finishedWork.return, error3);
                    }
                  }
                ...
                if (flags & FormReset) {
                  needsFormReset = true;
                  {
                    if (finishedWork.type !== "form") {
                      error2("Unexpected host component type. Expected a form. This is a bug in React.");
                    }
                  }
                }
              }
        ...
        function commitLayoutEffects(finishedWork, root, committedLanes) {
          ...
          setCurrentDebugFiberInDEV(finishedWork);
          var current2 = finishedWork.alternate;
          commitLayoutEffectOnFiber(root, current2, finishedWork);
          resetCurrentDebugFiberInDEV();
          inProgressLanes = null;
          inProgressRoot = null;
        }
        function recursivelyTraverseLayoutEffects(root, parentFiber, lanes) {
          ...
          if (parentFiber.subtreeFlags & LayoutMask) {
            ...
            while (child !== null) {
              ...
              commitLayoutEffectOnFiber(root, current2, child);
              child = child.sibling;
            }
          }
          setCurrentDebugFiberInDEV(prevDebugFiber);
        ...
        function reappearLayoutEffects(finishedRoot, current2, finishedWork, includeWorkInProgressEffects) {
          ...
          switch (finishedWork.tag) {
            ...
            case HostComponent: {
              recursivelyTraverseReappearLayoutEffects(finishedRoot, finishedWork, includeWorkInProgressEffects);
              if (includeWorkInProgressEffects && current2 === null && flags & Update2) {
                commitHostComponentMount(finishedWork);
              }
              safelyAttachRef(finishedWork, finishedWork.return);
              break;
            ...
            case Profiler: {
              recursivelyTraverseReappearLayoutEffects(finishedRoot, finishedWork, includeWorkInProgressEffects);
              if (includeWorkInProgressEffects && flags & Update2) {
                commitProfilerUpdate(finishedWork, current2);
              }
              break;
            }
        ...
        function queueConcurrentError(error3) {
                ...
                resumeOrUnwind: switch (workInProgressSuspendedReason) {
                  ...
                  case SuspendedOnInstanceAndReadyToContinue: {
                    ...
                    switch (workInProgress.tag) {
                      ...
                      default: {
                        if (true) {
                          error2("Unexpected type of fiber triggered a suspensey commit. This is a bug in React.");
                        }
                        break;
                      }
                    }
        ...
        function replaySuspendedUnitOfWork(unitOfWork) {
          ...
          switch (unitOfWork.tag) {
            case SimpleMemoComponent:
            case FunctionComponent: {
              var Component3 = unitOfWork.type;
              var unresolvedProps = unitOfWork.pendingProps;
              var resolvedProps = unresolvedProps;
              var context2;
              next = replayFunctionComponent(current2, unitOfWork, resolvedProps, Component3, context2, workInProgressRootRenderLanes);
              break;
            }
            case ForwardRef: {
        ...
        function panicOnRootError(root, error3) {
          workInProgressRootExitStatus = RootFatalErrored;
          logUncaughtError(root, createCapturedValueAtFiber(error3, root.current));
          workInProgress = null;
        }
          ...
          do {
            {
              if ((completedWork.flags & Incomplete) !== NoFlags$1) {
                error2("Internal React error: Expected this fiber to be complete, but it isn't. It should have been unwound. This is a bug in React.");
              }
            }
        ...
        function makeErrorInfo(componentStack) {
          ...
          };
          {
            Object.defineProperty(errorInfo, "digest", {
              get: function() {
                error2('You are accessing "digest" from the errorInfo object passed to onRecoverableError. This property is no longer provided as part of errorInfo but can be accessed as a property of the Error instance itself.');
              }
            });
          }
          return errorInfo;
        ...
        function captureCommitPhaseErrorOnRoot(rootFiber, sourceFiber, error3) {
          ...
          var update2 = createRootErrorUpdate(rootFiber.stateNode, errorInfo, SyncLane);
        ...
        function captureCommitPhaseError(sourceFiber, nearestMountedAncestor, error$1) {
          ...
          while (fiber !== null) {
            if (fiber.tag === HostRoot) {
              ...
              if (typeof ctor.getDerivedStateFromError === "function" || typeof instance.componentDidCatch === "function" && !isAlreadyFailedLegacyErrorBoundary(instance)) {
                ...
                var update2 = createClassErrorUpdate(SyncLane);
                var root = enqueueUpdate(fiber, update2, SyncLane);
                if (root !== null) {
                  initializeClassErrorUpdate(update2, root, fiber, errorInfo);
                  markRootUpdated(root, SyncLane);
                  ensureRootIsScheduled(root);
                }
                return;
          ...
          {
            error2("Internal React error: Attempted to capture a commit phase error inside a detached tree. This indicates a bug in React. Potential causes include deleting the same fiber more than once, committing an already-finished tree, or an inconsistent return pointer.\n\nError message:\n\n%s", error$1);
          }
        }
        ...
        function doubleInvokeEffectsOnFiber(root, fiber) {
          var shouldDoubleInvokePassiveEffects = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true;
          setIsStrictModeForDevtools(true);
              ...
              switch (fiber.tag) {
                ...
                case SimpleMemoComponent: {
                  ...
                  if (!didWarnAboutUpdateInRenderForAnotherComponent.has(dedupeKey)) {
                    ...
                    error2("Cannot update a component (`%s`) while rendering a different component (`%s`). To locate the bad setState() call inside `%s`, follow the stack trace as described in https://react.dev/link/setstate-in-render", setStateComponentName, renderingComponentName, renderingComponentName);
                  }
                  break;
                }
                case ClassComponent: {
        ...
        function createFiberFromTypeAndProps(type, key, pendingProps, owner, mode, lanes) {
          var fiberTag = FunctionComponent;
          var resolvedType = type;
          if (typeof type === "function") {
        ...
        function checkKeyStringCoercion(value) {
          {
            if (willCoercionThrow(value)) {
              error2("The provided key is an unsupported type %s. This value must be coerced to a string before using it here.", typeName(value));
              ...
              if (!didWarnAboutFindNodeInStrictMode[componentName2]) {
                ...
                try {
                  ...
                  if (fiber.mode & StrictLegacyMode) {
                    error2("%s is deprecated in StrictMode. %s was passed an instance of %s which is inside StrictMode. Instead, add a ref directly to the element you want to reference. Learn more about using refs safely here: https://react.dev/link/strict-mode-find-node", methodName, methodName, componentName2);
                  } else {
                    error2("%s is deprecated in StrictMode. %s was passed an instance of %s which renders StrictMode children. Instead, add a ref directly to the element you want to reference. Learn more about using refs safely here: https://react.dev/link/strict-mode-find-node", methodName, methodName, componentName2);
                  }
                } finally {
                  if (previousFiber) {
        ...
        function createHydrationContainer(initialChildren, callback, containerInfo, tag, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onUncaughtError, onCaughtError, onRecoverableError, transitionCallbacks, formState) {
          var hydrate = true;
          var root = createFiberRoot(containerInfo, tag, hydrate, initialChildren, hydrationCallbacks, isStrictMode, concurrentUpdatesByDefaultOverride, identifierPrefix, onUncaughtError, onCaughtError, onRecoverableError, transitionCallbacks, formState);
        ...
        function updateContainer(element, container, parentComponent, callback) {
          var current2 = container.current;
          var lane = requestUpdateLane(current2);
        ...
        function updateContainerSync(element, container, parentComponent, callback) {
          ...
          var current2 = container.current;
          updateContainerImpl(current2, SyncLane, element, container, parentComponent, callback);
          return SyncLane;
        }
        function updateContainerImpl(rootFiber, lane, element, container, parentComponent, callback) {
          ...
          var root = enqueueUpdate(rootFiber, update2, lane);
          if (root !== null) {
        ...
        exports2.defaultOnCaughtError = defaultOnCaughtError;
        exports2.defaultOnRecoverableError = defaultOnRecoverableError;
        exports2.defaultOnUncaughtError = defaultOnUncaughtError;
        ...
        exports2.flushSyncFromReconciler = flushSyncFromReconciler;
        ...
        exports2.startHostTransition = startHostTransition;
...
// node_modules/@react-three/fiber/dist/loop-ed5edcdb.esm.js
...
var catalogue = {};
var i = 0;
var isConstructor$1 = (object) => typeof object === "function";
...
var handleTextInstance = () => console.warn("R3F: Text is not allowed in JSX! This could be stray whitespace or characters.");
var NO_CONTEXT = {};
...
function applyProps(object, props) {
  ...
  for (const prop in props) {
    ...
    (__DEV__ ? target.constructor.name === value.constructor.name : target.constructor === value.constructor)) {
      ...
      root[key] = value;
      if (rootState && !rootState.linear && colorMaps.includes(key) && root[key] instanceof Texture && // sRGB textures must be RGBA8 since r137 https://github.com/mrdoob/three.js/pull/23129
  ...
  if (instance != null && instance.parent && rootState != null && rootState.internal && instance.object instanceof Object3D && prevHandlers !== instance.eventCount) {
    const index = rootState.internal.interaction.indexOf(instance.object);
    if (index > -1) rootState.internal.interaction.splice(index, 1);
    if (instance.eventCount && instance.object.raycast !== null && instance.object instanceof Object3D) {
      rootState.internal.interaction.push(instance.object);
    }
  }
  if (instance && instance.props.attach === void 0) {
    if (instance.object instanceof BufferGeometry) instance.props.attach = "geometry";
    else if (instance.object instanceof Material) instance.props.attach = "material";
  }
  ...
  function handleIntersects(intersections, event, delta, callback) {
    if (intersections.length) {
      ...
      for (const hit of intersections) {
        const state2 = getRootState(hit.object);
        if (state2) {
          const {
            raycaster,
            pointer,
...
function loadingFn(extensions, onProgress) {
  return async function(Proto, ...input) {
    ...
    return Promise.all(input.map((input2) => new Promise((res, reject) => loader.load(input2, (data) => res(isObject3D(data == null ? void 0 : data.scene) ? Object.assign(data, buildGraph(data.scene)) : data), onProgress, (error2) => reject(new Error(`Could not load ${input2}: ${error2 == null ? void 0 : error2.message}`))))));
  };
}
  ...
  return {
    configure(props = {}) {
      ...
      if (!configured) {
        ...
        applyProps(gl, {
          outputEncoding: linear ? LinearEncoding : sRGBEncoding2,
